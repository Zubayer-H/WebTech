...
<body>
     ...
     <form action="../Controller/roomController.php" method="POST">
     	<div class="backBtn">
     	...
     	<div class="container">
     		...
     		<input type="text" name="room_quality" placeholder="Room Quality"><br><br>
     		<input type="text" name="room_status" placeholder="Reserve Your Room"><br><br>
