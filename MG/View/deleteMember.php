...
<div class="mainContainer">
	...
	<a href="logout.php" ><button class="dlem">Logout</button></a><br>
		...
		<div align="center">
		<h3>Delete Member Profile</h3><br>
        <p><?php echo $result['name'];?>, Are you sure you want to delete your account?</p><br>
		
		
		<a style=" padding: 10px 30px; background-color: red; color: #ffffff; border: none; border-radius: 10px;" href="../Controller/deleteMemberController.php?id=<?php echo $id;?>">Delete</a>
		<a style=" padding: 10px 30px; background-color: blue; color: #ffffff; border: none; border-radius: 10px;" href="memberView.php">Go Back</a>
